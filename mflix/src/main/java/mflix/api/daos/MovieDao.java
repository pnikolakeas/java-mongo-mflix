...
public class MovieDao extends AbstractMFlixDao {
    ...
    private boolean validIdValue(String movieId) {
        ...
        for (Character ch : movieId.toCharArray()) {
            if (-1 == java.lang.Character.digit(ch, 16)) {
                return false;
            }
        }
        return true;
    ...
    /*
    Bson matchStage   = Aggregates.match(Filters.eq("genres", "History"));
    ...
    List<Bson> pipeline = Arrays.asList(matchStage, sortStage, skipStage, limitStage);
